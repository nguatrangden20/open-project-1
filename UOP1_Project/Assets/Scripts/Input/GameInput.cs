...
public partial class @GameInput: IInputActionCollection2, IDisposable
{
    ...
    ~@GameInput()
    {
        ...
        Debug.Assert(!m_Menus.enabled, "This will cause a leak and performance issues, GameInput.Menus.Disable() has not been called.");
        Debug.Assert(!m_Dialogues.enabled, "This will cause a leak and performance issues, GameInput.Dialogues.Disable() has not been called.");
        Debug.Assert(!m_Cheats.enabled, "This will cause a leak and performance issues, GameInput.Cheats.Disable() has not been called.");
    }
